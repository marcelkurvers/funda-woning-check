...
**Datum:** Mon Dec 22 23:50:44 CET 2025
...
| :--- | :--- | :--- | :--- | :--- |
| 1 | 1. Algemene Woningkenmerken | **2.7** | 0.0 | 🛑 Static |
| 2 | 2. Persoonlijke eisen & matchanalyse | **0.0** | 0.0 | 🛑 Static |
| 3 | 3. Bouwkundige Staat | **2.5** | 0.0 | 🛑 Static |
| 4 | 4. Energie & Duurzaamheid | **2.0** | 0.0 | 🛑 Static |
| 5 | 5. Indeling & Ruimtegebruik | **3.1** | 0.0 | ⚠️ Moderate |
| 6 | 6. Onderhoud & Afwerking | **3.3** | 0.0 | ⚠️ Moderate |
| 7 | 7. Tuin & Buitenruimte | **2.9** | 0.0 | 🛑 Static |
| 8 | 8. Parkeren & Bereikbaarheid | **0.4** | 0.0 | 🛑 Static |
| 9 | 9. Juridische Aspecten | **0.5** | 0.0 | 🛑 Static |
| 10 | 10. Financiële Analyse | **1.1** | 0.0 | 🛑 Static |
| 11 | 11. Marktpositie | **0.5** | 0.0 | 🛑 Static |
| 12 | 12. Advies & Conclusie | **0.7** | 0.0 | 🛑 Static |

## Totaalscore
**Gemiddelde Content Dynamiek:** 1.7 / 10
